...
export const StudySetCard = (props: StudySetCardProps) => {
  ...
  return (
    <article className="w-full p-3 rounded-xl font-medium bg-theme-background-light-variant flex items-center text-theme-brown-light gap-3">
      <StudySetCover
        className="text-theme-background-light-variant"
